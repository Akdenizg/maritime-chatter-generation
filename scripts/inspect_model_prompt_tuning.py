        ...
        for generated_output in results_to_check:
            ...
            if all(passed_filters[filter_name] != False for filter_name in self.filter_list if filter_name not in filters_to_exclude_from_check):
                results['valid_outputs'].append({
                    ...
                    "pruned_output": output_text.split("\n\n") if "\n\n" in output_text else output_text.split("\n"), 
...
if __name__ == "__main__":
    ...
    seed_path = './seed_outputs/seed_outputs.json' # seed instances path
    synthetic_chatter_path = "./synthetic_chatters/prompt_tuning/...json" # path of the synthetic chatter to be evaluated. This file should be generated by run_models_prompt_tuning.py
    save_dir = './evaluation/prompt_tuning/'
