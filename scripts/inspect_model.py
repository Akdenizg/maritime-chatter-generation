...
class ModelInspection:
    ...
    def assess_context_accuracy(self, filter_list, output, scenario_input, rouge_l_score, task_name):
        ...
        if task_name == "reporting_collision":
            passed_filters["collided_vessel_name"] = True
            passed_filters["collided_vessel_type"] = True
    ...
    def inspect(self):
        ...
        # Histogram data for scores_seed
...
if __name__ == "__main__":
    keywords_path = '/home/gakdeniz/Dev/ma-llm-tuning/data/keywords.json'
    ship_data_path = '/home/gakdeniz/Dev/ma-llm-tuning/data/ship_data_dk_us.pkl'

    land_shapefile = "/home/gakdeniz/Dev/ma-llm-tuning/GSHHS_dataset/geo-data/GSHHS_shp/f/GSHHS_f_L1.shp"
    geonames_data_path = '/home/gakdeniz/Dev/ma-llm-tuning/all_countries/allCountries.txt'
    seed_path = '/home/gakdeniz/Dev/ma-llm-tuning/seed_outputs/seed_outputs.json'
    synthetic_chatter_path = "/home/gakdeniz/Dev/ma-llm-tuning/synthetic_chatters/reporting_attack/20250710_1055.json" 
    save_dir = '/home/gakdeniz/Dev/ma-llm-tuning/evaluation'
