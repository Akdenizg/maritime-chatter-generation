...
## 6) Evaluation of Distress Calls Generated by the Fine-tuned Adapters

**Three evaluation metrics**:

| Evaluation Criteria         | Filters Used                                                        | Coefficient |
|----------------------------|---------------------------------------------------------------------|-------------|
| **Format Accuracy**        | Parentheses                                                          | 1           |
|                            | Bracket                                                              | 1           |
|                            | Mayday                                                               | 1           |
|                            | Incomplete                                                           | 2           |
...
| **Logical Coherence**      | Manual Evaluation|

**Score Calculation:**

## Format and Information Accuracy
